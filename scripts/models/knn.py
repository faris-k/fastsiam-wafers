...
from lightly.utils import knn_predict, scheduler
...
class FastSiam(KNNBenchmarkModule):
    def __init__(self, dataloader_kNN, num_classes, **kwargs):
        super().__init__(dataloader_kNN, num_classes, **kwargs)
        self.backbone = timm.create_model("resnet18", num_classes=0)
        feature_dim = self.backbone.num_features
...
class FastSiamSymmetrized(KNNBenchmarkModule):
    def __init__(self, dataloader_kNN, num_classes, **kwargs):
        super().__init__(dataloader_kNN, num_classes, **kwargs)
        self.backbone = timm.create_model("resnet18", num_classes=0)
        feature_dim = self.backbone.num_features
...
class DINOConvNeXt(KNNBenchmarkModule):
    def __init__(self, dataloader_kNN, num_classes, **kwargs):
        super().__init__(dataloader_kNN, num_classes, **kwargs)
...
class DINOXCiT(KNNBenchmarkModule):
    def __init__(self, dataloader_kNN, num_classes, **kwargs):
        super().__init__(dataloader_kNN, num_classes, **kwargs)
